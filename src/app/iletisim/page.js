        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white/70 p-8 rounded-2xl border-4 border-yellow-600 shadow-2xl backdrop-blur-md transition-transform hover:scale-[1.02]">
              <h3 className="text-3xl font-bold text-[#1abc9c] mb-8 border-b border-[#1abc9c] pb-2">İletişim Bilgileri</h3>
              <ul className="space-y-8">
                <li className="flex gap-4 items-start">
                  <svg className="w-7 h-7 text-[#1abc9c]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* İletişim Formu */}
            <div className="bg-white/70 p-8 rounded-2xl border-4 border-[#1abc9c] shadow-2xl backdrop-blur-md transition-transform hover:scale-[1.02]">

...
export default function MainClient() {
  const { translate } = useLanguage(); // en üstte
            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white px-4 rounded-xl">
              <h1 className="text-center mb-6">
                <span className="block text-4xl md:text-6xl font-medium leading-tight mb-4 bg-clip-text text-transparent bg-yellow-500">
                  {animatedText1}
                  {animatedText1.length < translate("mainHeading1").length && (
                    <span className="animate-pulse">|</span>
                  )}
                </span>
                <span className="block text-5xl md:text-7xl font-bold">
                  {animatedText2}
                  {animatedText1 === translate("mainHeading1") && animatedText2.length < translate("mainHeading2").length && (
                    <span className="animate-pulse">|</span>
                  )}
                </span>
                <div
                  ...
                  style={{
                    animation: animatedText2 === translate("mainHeading2") ? 'scaleIn 1s forwards' : ''
                  }}
                />
              </h1>
              ...
              <p
                ...
                style={{
                  animation: animatedText2 === translate("mainHeading2") ? 'fadeIn 1s forwards 0.5s' : ''
                }}
              >
                {translate("ulusalBarter")}
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="relative z-10 w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-16 py-12">
              ...
              <div className="lg:w-1/2 text-center lg:text-left space-y-6">
                <div className="space-y-4">
                  <h1 className="text-4xl md:text-5xl font-bold text-gray-600 tracking-tight leading-tight">
                    <span className="block">{translate("subtitle")}</span>
                    <span className="text-yellow-500">{translate("subtitleHighlight")}</span>
                  </h1>
                  <div className="w-24 h-1 bg-yellow-500 rounded-full lg:mx-0 mx-auto"></div>
                </div>

                <p className="text-xl md:text-2xl text-gray-600 font-medium">
                  {translate("subtitleDesc")}
                </p>

                <p className="text-lg text-yellow-500 italic font-medium">
                  &quot;{translate("subtitleQuote")}&quot;
                </p>
                <div className="mt-8">
              ...
              <div className="lg:w-1/2 lg:pl-8 lg:border-l lg:border-gray-700">
                <div className="space-y-6">
                  ...
                  {/* Tanıtım Başlığı */}
                  <h2 className="text-3xl font-bold text-yellow-500 text-center">{translate("promoVideoTitle")}</h2>
  ...
  `}</style>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
            <div className="text-center mb-12 md:mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-yellow-600 leading-tight">
                {translate("barterBenefits")}
              </h2>
              <p className="mt-4 text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
                {translate("barterBenefitsDesc")}
              </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              <div className="bg-white rounded-xl p-6 sm:p-8 flex flex-col items-center text-center border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{translate("cashFlow")}</h3>
                <p className="text-gray-600 leading-relaxed text-sm">{translate("cashFlowDesc")}</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 sm:p-8 flex flex-col items-center text-center border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{translate("stockManagement")}</h3>
                <p className="text-gray-600 leading-relaxed text-sm">{translate("stockManagementDesc")}</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 sm:p-8 flex flex-col items-center text-center border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{translate("marketAccess")}</h3>
                <p className="text-gray-600 leading-relaxed text-sm">{translate("marketAccessDesc")}</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 sm:p-8 flex flex-col items-center text-center border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{translate("secureTrade")}</h3>
                <p className="text-gray-600 leading-relaxed text-sm">{translate("secureTradeDesc")}</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 sm:p-8 flex flex-col items-center text-center border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{translate("flexibleSolutions")}</h3>
                <p className="text-gray-600 leading-relaxed text-sm">{translate("flexibleSolutionsDesc")}</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 sm:p-8 flex flex-col items-center text-center border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{translate("economicPower")}</h3>
                <p className="text-gray-600 leading-relaxed text-sm">{translate("economicPowerDesc")}</p>
              </div>
            </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-12 lg:px-24 text-white">
            <h2 className="text-3xl font-bold mb-10 text-center text-yellow-500">
              {translate("latestListings")}
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="bg-yellow-400/40 p-6 rounded-xl border border-yellow-400/20 hover:border-white/50 transition-all duration-300 backdrop-blur-sm flex flex-col items-center justify-center text-center space-y-4 min-h-[300px]">
                ...
                <ul className="space-y-2">
                  <li><a href="/hakkinda" className="text-yellow-200 hover:text-white transition">
                    {translate("aboutUs")}
                  </a></li>
                  <li><a href="/barter" className="text-yellow-200 hover:text-white transition">
                    {translate("barterSystem")}
                  </a></li>
                  <li><a href="/uyelik" className="text-yellow-200 hover:text-white transition">
              ...
              <div className="bg-yellow-400/40 p-6 rounded-xl border border-yellow-400/20 hover:border-white/50 transition-all duration-300 backdrop-blur-sm flex flex-col items-center justify-center text-center text-yellow-200 text-sm leading-6 min-h-[300px]">
                ...
                <p>{translate("addressDetail")}</p>
              </div>
            </div>

            {/* Alt Kısım - Telif ve Politikalar */}
            <div className="mt-4 pt-4 border-translate border-yellow-100/30 w-full text-center">
              <p className="text-yellow-100 text-sm">
                © {new Date().getFullYear()} Ulusal Barter A.Ş. {translate("copyright")}
              </p>
              <div className="mt-2 flex justify-center space-x-2">
                <a href="/privacy" className="text-yellow-100 hover:text-white text-xs transition-colors">
                  {translate("privacyPolicy")}
                </a>
                <a href="/cookies" className="text-yellow-100 hover:text-white text-xs transition-colors">
                  {translate("cookies")}
                </a>
                <a href="/terms" className="text-yellow-100 hover:text-white text-xs transition-colors">
                  {translate("terms")}
                </a>
              </div>
            </div>
